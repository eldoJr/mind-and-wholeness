        ...
        <div className="mt-20 border-t border-gray-200 pt-16">
          <div className="flex flex-col items-center text-center">
            <img
              ...
              className="w-full max-w-sm sm:max-w-md lg:max-w-lg h-auto object-cover rounded-lg shadow-lg mb-6"
            />
            <p className="text-2xl sm:text-3xl font-serif italic font-light text-gray-800 tracking-wide">
                Mrs. Lilian Titus
            </p>
            <p className="text-lg font-serif text-emerald-600 font-medium mt-2">
              CEO & Founder
            </p>
          </div>
        </div>
