  ...
  return (
    <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 font-serif text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-gray-900 leading-snug mb-10">
        ...
        <form className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mb-8">
          <input
            type="text"
        ...
        <button
          type="submit"
          className="mt-4 px-6 py-3 bg-rose-600 text-white font-medium tracking-wide uppercase text-sm rounded-sm hover:bg-rose-700 transition-all shadow-sm"
        >
          Join Now
        </button>
      </div>
